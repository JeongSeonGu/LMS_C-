...
public sealed class RequestsForm : Form
{
    ...
    private readonly Button _addButton = new() { Left = 470, Top = 14, Width = 90, Text = "등록..." };
    ...
    private readonly Button _editButton = new() { Left = 20, Top = 440, Width = 80, Text = "수정..." };
    private readonly Button _deleteButton = new() { Left = 108, Top = 440, Width = 80, Text = "삭제" };
    private readonly Button _refreshButton = new() { Left = 470, Top = 440, Width = 80, Text = "새로고침" };
